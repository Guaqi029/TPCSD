...
DATA_ROOT="${DATA_ROOT:-/data/DataLACP/guyiqin/ISIC_Archive}" # 数据集图像根目录
SPLIT_DIR="${SPLIT_DIR:-/data/DataLACP/guyiqin/CODE/TPCSD/split/ISIC_Archive}" # 训练/验证/测试划分文件目录
...
RUN_NAME="run_tpcsd_stage2_isic_archive_${TIMESTAMP}" # 本次 Stage2 运行目录名

STAGE2_ARGS=(
  --dataset ISIC_Archive # 数据集名称
